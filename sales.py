...
class salesClass:
    def __init__(self, root):
        ...
        #title
        lbl_title=Label(self.root,text="View Customer Bill",font=("times new roman",30),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=20)
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("times new roman",15,"bold"),bg="lightgray",fg="white").place(x=490,y=100,width=120,height=28)
        ...
        lbl_title2=Label(bill_Frame,text="Customer Bill Area",font=("times new roman",20),bg="orange").pack(side=TOP,fill=X)
